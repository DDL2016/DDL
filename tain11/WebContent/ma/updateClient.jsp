...
<ul>
             ...
             <li><a href="#" class="on">删除学生信息</a></li>
             </ul>
</div>
</div>
...
输入你要删除的姓名:<input type="text" name="mingzi"><br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="删除" class="btn btn-primary btn-lg active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="清除" class="btn btn-primary btn-lg active">
</form>
</div>
<br><br><br>
<br><br><br>
