...
<ul>
             ...
             <li><a href="xiugaizhaopin.jsp" class="on">修改招聘信息</a></li>
...
<div align="center">
<h1>修改招聘信息</h1>
<form action="xiugaizhaopincheck.jsp" method="post">
...
<br>
是否健康:<input type="text" name="health"><br>
<br>
家庭地址:<input type="text" name="adddress"><br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
